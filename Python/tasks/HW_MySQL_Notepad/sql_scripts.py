...
IS_NOTE_EXISTS = "SELECT EXISTS(SELECT id FROM note WHERE id = '{}')"
UPDATE_NOTE = "UPDATE note SET `note` = '{}' WHERE id = '{}' AND user_id = '{}';"
SELECT_NOTE_BY_ID = "SELECT * FROM note WHERE id = '{}';"
SELECT_ALL_NOTES = "SELECT * FROM note;"
SELECT_ALL_NOTES_BY_DATE = "SELECT * FROM note WHERE date BETWEEN '{} 00:00:01' AND '{} 23:59:59';"
SELECT_ALL_BY_INCLUDE_WORD = "SELECT * FROM note WHERE `note` LIKE '%{}%';"
